import dogImage from "./hero-dog.png";
import catImage from "./hero-cat.png";
    ...
    <section className="hero-section" aria-labelledby="hero-title">
      <div className="container-fluid hero-section__container">
        <div className="hero-section__copy">
          <p className="hero-section__eyebrow"><span>♡</span> CUIDAMOS A QUIENES AMAS</p>
          <h1 id="hero-title">
            Salud y amor<br />para tu <span>mejor amigo</span>
          </h1>
        ...
        <div className="hero-section__visual" aria-label="Perro y gato de la clínica">
          ...
          <img className="hero-section__dog" src={dogImage} alt="Perro golden retriever" />
          <img className="hero-section__cat" src={catImage} alt="Gato atigrado" />
        </div>
      </div>
    </section>
  );
